...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Visit Mom Bakers in Taragarh, Punjab. Call or WhatsApp +91 62807 81239.",
      },
    ],
  }),
    ...
    <div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16 grid lg:grid-cols-2 gap-10">
        <div className="space-y-5">
          ...
          <a
            href="https://wa.me/916280781239"
            className="mt-4 inline-flex items-center gap-2 bg-[#25D366] text-white px-7 py-3.5 rounded-full font-medium hover:opacity-90 transition shadow-[var(--shadow-soft)]"
          >
